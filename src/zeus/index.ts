...
export type ValueTypes = {
    ["Mutation"]: AliasType<{
createTask?: [{	description: string,	owner: string,	taskStatus: string,	title: string},ValueTypes["Task"]],
updateTaskBody?: [{	description: string,	id: string,	title: string},ValueTypes["Task"]],
updateTaskStatus?: [{	id: string,	taskStatus: string},ValueTypes["Task"]],
		__typename?: boolean | `@${string}`
}>;
	["Query"]: AliasType<{
allTasks?: [{	nextToken?: string | undefined | null},ValueTypes["TaskConnection"]],
getTask?: [{	id: string},ValueTypes["Task"]],
	...
	taskStatus?:boolean | `@${string}`,
	title?:boolean | `@${string}`,
		__typename?: boolean | `@${string}`
}>;
	["TaskConnection"]: AliasType<{
	items?:ValueTypes["Task"],
...
export type ModelTypes = {
    ["Mutation"]: {
		createTask?: GraphQLTypes["Task"] | undefined,
	updateTaskBody?: GraphQLTypes["Task"] | undefined,
	updateTaskStatus?: GraphQLTypes["Task"] | undefined
};
	["Query"]: {
		allTasks?: GraphQLTypes["TaskConnection"] | undefined,
	getTask?: GraphQLTypes["Task"] | undefined
};
	["Task"]: {
		description: string,
	id: string,
	...
	["TaskConnection"]: {
		items?: Array<GraphQLTypes["Task"] | undefined> | undefined,
